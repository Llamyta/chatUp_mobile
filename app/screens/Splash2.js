...
import Img3 from '../../assets/imageSplash(3).png'
        ...
        >
            <View style={[styles.container, { paddingHorizontal: 30 }]}>
                ...
                >
                    ...
                    <Text style={[styles.title, { textAlign: 'center', color: '#1196BA', fontSize: 17 }]}>Contact with friends</Text>
                ...
                >
                    ...
                    <View style={styles.efecto}>
                        ...
                        <View style={styles.txt}>
                            <Text style={[styles.title, { color: '#fff', textAlign: 'center', paddingRight: '15%' }]}>...</Text>
                        </View>
                    </View>
                </Animatable.View> */}
            {/* </View> */}
                    ...
                    >
                        ...
                        <View style={[styles.efecto]}>
                            ...
                            <View style={[styles.txt, { paddingRight: '8%' }]}>
                                ...
                                <Text style={styles.text}>Chat with friends arround the world</Text>
